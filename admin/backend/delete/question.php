...
if (isset($_GET['id'])) {
    ...
    if ($stmt->rowCount() > 0) {
        ...
        header("Location: ../../manage-questions.php?id=" . $_GET["survey_id"] . "&success=" . urlencode($successMessage));
        exit;
    } else {
        // Set error message and redirect
        $errorMessage = "Error deleting record.";
        header("Location: ../../update-question.php?id=" . $_GET["survey_id"] . "&error=" . urlencode($errorMessage));
        exit;
    }
}